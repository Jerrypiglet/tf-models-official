...
#define __PYX_HAVE__extern__render__render_egl
#define __PYX_HAVE_API__extern__render__render_egl
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* "extern/render/render_egl.pyx":15
 * 
 * DTYPE = np.float64
 ...
 * 
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_6extern_6render_10render_egl_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'extern.render.render_egl' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_6extern_6render_10render_egl_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_6extern_6render_10render_egl_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t = { "uint8_t", NULL, sizeof(__pyx_t_5numpy_uint8_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_5numpy_uint8_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_5numpy_uint8_t), 0 };
#define __Pyx_MODULE_NAME "extern.render.render_egl"
int __pyx_module_is_main_extern__render__render_egl = 0;

/* Implementation of 'extern.render.render_egl' */
...
static const char __pyx_k_dtype[] = "dtype";
static const char __pyx_k_f_num[] = "f_num";
static const char __pyx_k_faces[] = "faces";
static const char __pyx_k_numpy[] = "numpy";
static const char __pyx_k_range[] = "range";
static const char __pyx_k_uint8[] = "uint8";
static const char __pyx_k_v_num[] = "v_num";
...
static const char __pyx_k_mask_bool[] = "mask_bool";
static const char __pyx_k_transpose[] = "transpose";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_renderMesh_np[] = "renderMesh_np";
static const char __pyx_k_render_egl_pyx[] = "render_egl.pyx";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_extern_render_render_egl[] = "extern.render.render_egl";
...
static PyObject *__pyx_n_s_dtype;
static PyObject *__pyx_n_s_extern_render_render_egl;
static PyObject *__pyx_n_s_f_num;
...
static PyObject *__pyx_n_s_mask_bool;
...
static PyObject *__pyx_n_s_renderMesh_np;
static PyObject *__pyx_kp_s_render_egl_pyx;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_n_s_transpose;
static PyObject *__pyx_n_s_uint8;
static PyObject *__pyx_kp_u_unknown_dtype_code_in_numpy_pxd;
static PyObject *__pyx_n_s_v_num;
static PyObject *__pyx_n_s_vertices;
static PyObject *__pyx_n_s_width;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_6extern_6render_10render_egl_renderMesh_np(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_vertices, PyArrayObject *__pyx_v_faces, PyArrayObject *__pyx_v_intrinsic, int __pyx_v_height, int __pyx_v_width); /* proto */
...
/* "extern/render/render_egl.pyx":18
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_6extern_6render_10render_egl_1renderMesh_np(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_6extern_6render_10render_egl_1renderMesh_np = {"renderMesh_np", (PyCFunction)__pyx_pw_6extern_6render_10render_egl_1renderMesh_np, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_6extern_6render_10render_egl_1renderMesh_np(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("renderMesh_np (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_vertices,&__pyx_n_s_faces,&__pyx_n_s_intrinsic,&__pyx_n_s_height,&__pyx_n_s_width,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_faces)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("renderMesh_np", 1, 5, 5, 1); __PYX_ERR(0, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_intrinsic)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("renderMesh_np", 1, 5, 5, 2); __PYX_ERR(0, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_height)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("renderMesh_np", 1, 5, 5, 3); __PYX_ERR(0, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_width)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("renderMesh_np", 1, 5, 5, 4); __PYX_ERR(0, 18, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "renderMesh_np") < 0)) __PYX_ERR(0, 18, __pyx_L3_error)
      }
    ...
    __pyx_v_faces = ((PyArrayObject *)values[1]);
    __pyx_v_intrinsic = ((PyArrayObject *)values[2]);
    __pyx_v_height = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_height == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_width = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_width == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 21, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("renderMesh_np", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 18, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("extern.render.render_egl.renderMesh_np", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_faces), __pyx_ptype_5numpy_ndarray, 1, "faces", 0))) __PYX_ERR(0, 19, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_intrinsic), __pyx_ptype_5numpy_ndarray, 1, "intrinsic", 0))) __PYX_ERR(0, 20, __pyx_L1_error)
  __pyx_r = __pyx_pf_6extern_6render_10render_egl_renderMesh_np(__pyx_self, __pyx_v_vertices, __pyx_v_faces, __pyx_v_intrinsic, __pyx_v_height, __pyx_v_width);
...
static PyObject *__pyx_pf_6extern_6render_10render_egl_renderMesh_np(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_vertices, PyArrayObject *__pyx_v_faces, PyArrayObject *__pyx_v_intrinsic, int __pyx_v_height, int __pyx_v_width) {
  int __pyx_v_v_num;
  int __pyx_v_f_num;
  PyArrayObject *__pyx_v_depth = 0;
  PyArrayObject *__pyx_v_mask = 0;
  bool *__pyx_v_mask_bool;
  ...
  __Pyx_RefNannySetupContext("renderMesh_np", 0);
  ...
  __pyx_pybuffernd_intrinsic.rcbuffer = &__pyx_pybuffer_intrinsic;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_vertices.rcbuffer->pybuffer, (PyObject*)__pyx_v_vertices, &__Pyx_TypeInfo_nn___pyx_t_6extern_6render_10render_egl_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 18, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_faces.rcbuffer->pybuffer, (PyObject*)__pyx_v_faces, &__Pyx_TypeInfo_nn___pyx_t_6extern_6render_10render_egl_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 18, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_intrinsic.rcbuffer->pybuffer, (PyObject*)__pyx_v_intrinsic, &__Pyx_TypeInfo_nn___pyx_t_6extern_6render_10render_egl_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 18, __pyx_L1_error)
  }
  ...
  /* "extern/render/render_egl.pyx":23
 ...
 * 
 */
  __pyx_v_v_num = (__pyx_v_vertices->dimensions[0]);

  /* "extern/render/render_egl.pyx":24
 * 
 *     cdef int v_num = vertices.shape[0];
 *     cdef int f_num = faces.shape[0];             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_f_num = (__pyx_v_faces->dimensions[0]);

  /* "extern/render/render_egl.pyx":26
 *     cdef int f_num = faces.shape[0];
 * 
 *     vertices = vertices.transpose().copy()             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_vertices), __pyx_n_s_transpose); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 26, __pyx_L1_error)
  ...
  __pyx_t_5 = ((PyArrayObject *)__pyx_t_1);
  {
    ...
    __pyx_t_6 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_vertices.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_6extern_6render_10render_egl_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_6 < 0)) {
      PyErr_Fetch(&__pyx_t_7, &__pyx_t_8, &__pyx_t_9);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_vertices.rcbuffer->pybuffer, (PyObject*)__pyx_v_vertices, &__Pyx_TypeInfo_nn___pyx_t_6extern_6render_10render_egl_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_5 = 0;
  __Pyx_DECREF_SET(__pyx_v_vertices, ((PyArrayObject *)__pyx_t_1));
  __pyx_t_1 = 0;

  /* "extern/render/render_egl.pyx":27
 * 
 *     vertices = vertices.transpose().copy()
 *     faces = faces.transpose().copy()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_faces), __pyx_n_s_transpose); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = NULL;
  ...
  __pyx_t_10 = ((PyArrayObject *)__pyx_t_1);
  {
    ...
    __pyx_t_6 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_faces.rcbuffer->pybuffer, (PyObject*)__pyx_t_10, &__Pyx_TypeInfo_nn___pyx_t_6extern_6render_10render_egl_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
    if (unlikely(__pyx_t_6 < 0)) {
      PyErr_Fetch(&__pyx_t_9, &__pyx_t_8, &__pyx_t_7);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_faces.rcbuffer->pybuffer, (PyObject*)__pyx_v_faces, &__Pyx_TypeInfo_nn___pyx_t_6extern_6render_10render_egl_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "extern/render/render_egl.pyx":30
 * 
 *     cdef np.ndarray[DTYPE_t, ndim=1] color;
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_height); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_11 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_float32); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_t_4, __pyx_n_s_dtype, __pyx_t_11) < 0) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_11 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, __pyx_t_4); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 30, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (!(likely(((__pyx_t_11) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_11, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 30, __pyx_L1_error)
  __pyx_t_12 = ((PyArrayObject *)__pyx_t_11);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_depth.rcbuffer->pybuffer, (PyObject*)__pyx_t_12, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "extern/render/render_egl.pyx":31
 *     cdef np.ndarray[DTYPE_t, ndim=1] color;
 *     cdef np.ndarray[np.float32_t, ndim=2] depth = np.zeros((height, width), dtype=np.float32);
 *     cdef np.ndarray[np.uint8_t, ndim=2, cast=True] mask = np.zeros((height, width), dtype=np.uint8);             # <<<<<<<<<<<<<<
 *     cdef bool *mask_bool = <bool*> &mask[0, 0]
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_11, __pyx_n_s_zeros); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  __pyx_t_11 = __Pyx_PyInt_From_int(__pyx_v_height); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_width); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __pyx_t_11 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_11)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_11);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_11, __pyx_n_s_uint8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_11); __pyx_t_11 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_mask.rcbuffer->pybuffer, (PyObject*)__pyx_t_13, &__Pyx_TypeInfo_nn___pyx_t_5numpy_uint8_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 1, __pyx_stack) == -1)) {
  ...
  /* "extern/render/render_egl.pyx":32
 *     cdef np.ndarray[np.float32_t, ndim=2] depth = np.zeros((height, width), dtype=np.float32);
 *     cdef np.ndarray[np.uint8_t, ndim=2, cast=True] mask = np.zeros((height, width), dtype=np.uint8);
 *     cdef bool *mask_bool = <bool*> &mask[0, 0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  } else if (unlikely(__pyx_t_14 >= __pyx_pybuffernd_mask.diminfo[0].shape)) __pyx_t_6 = 0;
  if (__pyx_t_15 < 0) {
    __pyx_t_15 += __pyx_pybuffernd_mask.diminfo[1].shape;
    if (unlikely(__pyx_t_15 < 0)) __pyx_t_6 = 1;
  } else if (unlikely(__pyx_t_15 >= __pyx_pybuffernd_mask.diminfo[1].shape)) __pyx_t_6 = 1;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
    __PYX_ERR(0, 32, __pyx_L1_error)
  }
  __pyx_v_mask_bool = ((bool *)(&(*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_mask.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_mask.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_mask.diminfo[1].strides))));

  /* "extern/render/render_egl.pyx":34
 *     cdef bool *mask_bool = <bool*> &mask[0, 0]
 * 
 *     renderMesh(&faces[0, 0], f_num,             # <<<<<<<<<<<<<<
 *                &vertices[0, 0], v_num,
 ...
 */
  ...
  __pyx_t_6 = -1;
  if (__pyx_t_16 < 0) {
    __pyx_t_16 += __pyx_pybuffernd_faces.diminfo[0].shape;
    if (unlikely(__pyx_t_16 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_16 >= __pyx_pybuffernd_faces.diminfo[0].shape)) __pyx_t_6 = 0;
  if (__pyx_t_17 < 0) {
    __pyx_t_17 += __pyx_pybuffernd_faces.diminfo[1].shape;
    if (unlikely(__pyx_t_17 < 0)) __pyx_t_6 = 1;
  } else if (unlikely(__pyx_t_17 >= __pyx_pybuffernd_faces.diminfo[1].shape)) __pyx_t_6 = 1;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
    __PYX_ERR(0, 34, __pyx_L1_error)
  }

  /* "extern/render/render_egl.pyx":35
 * 
 *     renderMesh(&faces[0, 0], f_num,
 *                &vertices[0, 0], v_num,             # <<<<<<<<<<<<<<
 *                &intrinsic[0],
 ...
 */
  ...
  __pyx_t_6 = -1;
  if (__pyx_t_18 < 0) {
    __pyx_t_18 += __pyx_pybuffernd_vertices.diminfo[0].shape;
    if (unlikely(__pyx_t_18 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_18 >= __pyx_pybuffernd_vertices.diminfo[0].shape)) __pyx_t_6 = 0;
  if (__pyx_t_19 < 0) {
    __pyx_t_19 += __pyx_pybuffernd_vertices.diminfo[1].shape;
    if (unlikely(__pyx_t_19 < 0)) __pyx_t_6 = 1;
  } else if (unlikely(__pyx_t_19 >= __pyx_pybuffernd_vertices.diminfo[1].shape)) __pyx_t_6 = 1;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
    __PYX_ERR(0, 35, __pyx_L1_error)
  }

  /* "extern/render/render_egl.pyx":36
 *     renderMesh(&faces[0, 0], f_num,
 *                &vertices[0, 0], v_num,
 *                &intrinsic[0],             # <<<<<<<<<<<<<<
 *                height, width,
 ...
 */
  ...
  __pyx_t_6 = -1;
  if (__pyx_t_20 < 0) {
    __pyx_t_20 += __pyx_pybuffernd_intrinsic.diminfo[0].shape;
    if (unlikely(__pyx_t_20 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_20 >= __pyx_pybuffernd_intrinsic.diminfo[0].shape)) __pyx_t_6 = 0;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
    __PYX_ERR(0, 36, __pyx_L1_error)
  }

  /* "extern/render/render_egl.pyx":38
 *                &intrinsic[0],
 *                height, width,
 *                &depth[0, 0],             # <<<<<<<<<<<<<<
 *                mask_bool)
 ...
 */
  ...
  __pyx_t_6 = -1;
  if (__pyx_t_21 < 0) {
    __pyx_t_21 += __pyx_pybuffernd_depth.diminfo[0].shape;
    if (unlikely(__pyx_t_21 < 0)) __pyx_t_6 = 0;
  } else if (unlikely(__pyx_t_21 >= __pyx_pybuffernd_depth.diminfo[0].shape)) __pyx_t_6 = 0;
  if (__pyx_t_22 < 0) {
    __pyx_t_22 += __pyx_pybuffernd_depth.diminfo[1].shape;
    if (unlikely(__pyx_t_22 < 0)) __pyx_t_6 = 1;
  } else if (unlikely(__pyx_t_22 >= __pyx_pybuffernd_depth.diminfo[1].shape)) __pyx_t_6 = 1;
  if (unlikely(__pyx_t_6 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_6);
 ...
 *                &intrinsic[0],
 */
  renderMesh((&(*__Pyx_BufPtrStrided2d(__pyx_t_6extern_6render_10render_egl_DTYPE_t *, __pyx_pybuffernd_faces.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_faces.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_faces.diminfo[1].strides))), __pyx_v_f_num, (&(*__Pyx_BufPtrStrided2d(__pyx_t_6extern_6render_10render_egl_DTYPE_t *, __pyx_pybuffernd_vertices.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_vertices.diminfo[0].strides, __pyx_t_19, __pyx_pybuffernd_vertices.diminfo[1].strides))), __pyx_v_v_num, (&(*__Pyx_BufPtrStrided1d(__pyx_t_6extern_6render_10render_egl_DTYPE_t *, __pyx_pybuffernd_intrinsic.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_intrinsic.diminfo[0].strides))), __pyx_v_height, __pyx_v_width, (&(*__Pyx_BufPtrStrided2d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_depth.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_depth.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_depth.diminfo[1].strides))), __pyx_v_mask_bool);

  /* "extern/render/render_egl.pyx":40
 *                &depth[0, 0],
 *                mask_bool)
 *     depth[mask == 0] = -1.0             # <<<<<<<<<<<<<<
 * 
 *     return depth, mask
 */
  __pyx_t_1 = PyObject_RichCompare(((PyObject *)__pyx_v_mask), __pyx_int_0, Py_EQ); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 40, __pyx_L1_error)
  if (unlikely(PyObject_SetItem(((PyObject *)__pyx_v_depth), __pyx_t_1, __pyx_float_neg_1_0) < 0)) __PYX_ERR(0, 40, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "extern/render/render_egl.pyx":42
 *     depth[mask == 0] = -1.0
 * 
 *     return depth, mask             # <<<<<<<<<<<<<<
 */
  ...
  PyTuple_SET_ITEM(__pyx_t_1, 0, ((PyObject *)__pyx_v_depth));
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_dtype, __pyx_k_dtype, sizeof(__pyx_k_dtype), 0, 0, 1, 1},
  {&__pyx_n_s_extern_render_render_egl, __pyx_k_extern_render_render_egl, sizeof(__pyx_k_extern_render_render_egl), 0, 0, 1, 1},
  {&__pyx_n_s_f_num, __pyx_k_f_num, sizeof(__pyx_k_f_num), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_mask_bool, __pyx_k_mask_bool, sizeof(__pyx_k_mask_bool), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_renderMesh_np, __pyx_k_renderMesh_np, sizeof(__pyx_k_renderMesh_np), 0, 0, 1, 1},
  {&__pyx_kp_s_render_egl_pyx, __pyx_k_render_egl_pyx, sizeof(__pyx_k_render_egl_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_test, __pyx_k_test, sizeof(__pyx_k_test), 0, 0, 1, 1},
  {&__pyx_n_s_transpose, __pyx_k_transpose, sizeof(__pyx_k_transpose), 0, 0, 1, 1},
  {&__pyx_n_s_uint8, __pyx_k_uint8, sizeof(__pyx_k_uint8), 0, 0, 1, 1},
  {&__pyx_kp_u_unknown_dtype_code_in_numpy_pxd, __pyx_k_unknown_dtype_code_in_numpy_pxd, sizeof(__pyx_k_unknown_dtype_code_in_numpy_pxd), 0, 1, 0, 0},
  {&__pyx_n_s_v_num, __pyx_k_v_num, sizeof(__pyx_k_v_num), 0, 0, 1, 1},
 ...
 *                   np.ndarray[DTYPE_t, ndim=1] intrinsic,
 */
  __pyx_tuple__10 = PyTuple_Pack(11, __pyx_n_s_vertices, __pyx_n_s_faces, __pyx_n_s_intrinsic, __pyx_n_s_height, __pyx_n_s_width, __pyx_n_s_v_num, __pyx_n_s_f_num, __pyx_n_s_color, __pyx_n_s_depth, __pyx_n_s_mask, __pyx_n_s_mask_bool); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(5, 0, 11, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_render_egl_pyx, __pyx_n_s_renderMesh_np, 18, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initrender_egl(void); /*proto*/
PyMODINIT_FUNC initrender_egl(void)
#else
PyMODINIT_FUNC PyInit_render_egl(void); /*proto*/
PyMODINIT_FUNC PyInit_render_egl(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_render_egl(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("render_egl", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_extern__render__render_egl) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "extern.render.render_egl")) {
      if (unlikely(PyDict_SetItemString(modules, "extern.render.render_egl", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "extern/render/render_egl.pyx":3
 ...
 */
  ...
  /* "extern/render/render_egl.pyx":14
 ...
 *                   np.ndarray[DTYPE_t, ndim=1] intrinsic,
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_6extern_6render_10render_egl_1renderMesh_np, NULL, __pyx_n_s_extern_render_render_egl); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_renderMesh_np, __pyx_t_2) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "extern/render/render_egl.pyx":1
 * from __future__ import division             # <<<<<<<<<<<<<<
 * from libcpp cimport bool
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init extern.render.render_egl", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init extern.render.render_egl");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
