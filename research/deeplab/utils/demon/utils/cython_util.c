...
#define __PYX_HAVE__data__cython_util
#define __PYX_HAVE_API__data__cython_util
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* "data/cython_util.pyx":7
 * DTYPE = np.float32
 * 
 * ctypedef np.float32_t DTYPE_t             # <<<<<<<<<<<<<<
 * 
 * def gen_depth_map(np.ndarray[DTYPE_t, ndim=2] proj, int height, int width):
 */
typedef __pyx_t_5numpy_float32_t __pyx_t_4data_11cython_util_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'data.cython_util' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_4data_11cython_util_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_4data_11cython_util_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "data.cython_util"
int __pyx_module_is_main_data__cython_util = 0;

/* Implementation of 'data.cython_util' */
...
static const char __pyx_k_data_cython_util[] = "data.cython_util";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_home_peng_baidu_VideoSegRec_DeM[] = "/home/peng/baidu/VideoSegRec/DeMoN/data/cython_util.pyx";
...
static PyObject *__pyx_n_s_data_cython_util;
static PyObject *__pyx_n_s_depth;
static PyObject *__pyx_n_s_dtype;
static PyObject *__pyx_n_s_float32;
static PyObject *__pyx_n_s_gen_depth_map;
static PyObject *__pyx_n_s_height;
static PyObject *__pyx_kp_s_home_peng_baidu_VideoSegRec_DeM;
...
static PyObject *__pyx_pf_4data_11cython_util_gen_depth_map(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_proj, int __pyx_v_height, int __pyx_v_width); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_4data_11cython_util_1gen_depth_map(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4data_11cython_util_1gen_depth_map = {"gen_depth_map", (PyCFunction)__pyx_pw_4data_11cython_util_1gen_depth_map, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_4data_11cython_util_1gen_depth_map(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_proj,&__pyx_n_s_height,&__pyx_n_s_width,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_height)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("gen_depth_map", 1, 3, 3, 1); __PYX_ERR(0, 9, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_width)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("gen_depth_map", 1, 3, 3, 2); __PYX_ERR(0, 9, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "gen_depth_map") < 0)) __PYX_ERR(0, 9, __pyx_L3_error)
      }
    ...
    __pyx_v_height = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_height == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_width = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_width == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("gen_depth_map", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("data.cython_util.gen_depth_map", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_proj), __pyx_ptype_5numpy_ndarray, 1, "proj", 0))) __PYX_ERR(0, 9, __pyx_L1_error)
  __pyx_r = __pyx_pf_4data_11cython_util_gen_depth_map(__pyx_self, __pyx_v_proj, __pyx_v_height, __pyx_v_width);
...
static PyObject *__pyx_pf_4data_11cython_util_gen_depth_map(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_proj, int __pyx_v_height, int __pyx_v_width) {
  ...
  __pyx_pybuffernd_proj.rcbuffer = &__pyx_pybuffer_proj;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_proj.rcbuffer->pybuffer, (PyObject*)__pyx_v_proj, &__Pyx_TypeInfo_nn___pyx_t_4data_11cython_util_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 9, __pyx_L1_error)
  }
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_height); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_width); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 10, __pyx_L1_error)
  ...
  __pyx_t_4 = 0;
  __pyx_t_4 = PyDict_New(); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_1 = __Pyx_GetModuleGlobalName(__pyx_n_s_DTYPE); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 10, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_depth.rcbuffer->pybuffer, (PyObject*)__pyx_t_5, &__Pyx_TypeInfo_nn___pyx_t_4data_11cython_util_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
 ...
 *         y = int(proj[1, i])
 */
  __pyx_t_6 = __pyx_v_pix_num;
  for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_6; __pyx_t_7+=1) {
    __pyx_v_i = __pyx_t_7;

    /* "data/cython_util.pyx":15
 *     cdef int y
 *     for i in range(pix_num):
 *         x = int(proj[0, i])             # <<<<<<<<<<<<<<
 *         y = int(proj[1, i])
 ...
 */
    ...
    __pyx_t_10 = -1;
    if (__pyx_t_8 < 0) {
      __pyx_t_8 += __pyx_pybuffernd_proj.diminfo[0].shape;
      if (unlikely(__pyx_t_8 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_8 >= __pyx_pybuffernd_proj.diminfo[0].shape)) __pyx_t_10 = 0;
    if (__pyx_t_9 < 0) {
      __pyx_t_9 += __pyx_pybuffernd_proj.diminfo[1].shape;
      if (unlikely(__pyx_t_9 < 0)) __pyx_t_10 = 1;
    } else if (unlikely(__pyx_t_9 >= __pyx_pybuffernd_proj.diminfo[1].shape)) __pyx_t_10 = 1;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 15, __pyx_L1_error)
    }
    __pyx_v_x = ((int)(*__Pyx_BufPtrStrided2d(__pyx_t_4data_11cython_util_DTYPE_t *, __pyx_pybuffernd_proj.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_proj.diminfo[0].strides, __pyx_t_9, __pyx_pybuffernd_proj.diminfo[1].strides)));

    /* "data/cython_util.pyx":16
 *     for i in range(pix_num):
 *         x = int(proj[0, i])
 *         y = int(proj[1, i])             # <<<<<<<<<<<<<<
 *         if 0 < x and x <= width and 0 < y and y <= height:
 *             cur_depth = depth[x-1][y-1]
 */
    __pyx_t_11 = 1;
    __pyx_t_12 = __pyx_v_i;
    __pyx_t_10 = -1;
    if (__pyx_t_11 < 0) {
      __pyx_t_11 += __pyx_pybuffernd_proj.diminfo[0].shape;
      if (unlikely(__pyx_t_11 < 0)) __pyx_t_10 = 0;
    } else if (unlikely(__pyx_t_11 >= __pyx_pybuffernd_proj.diminfo[0].shape)) __pyx_t_10 = 0;
    if (__pyx_t_12 < 0) {
      __pyx_t_12 += __pyx_pybuffernd_proj.diminfo[1].shape;
      if (unlikely(__pyx_t_12 < 0)) __pyx_t_10 = 1;
    } else if (unlikely(__pyx_t_12 >= __pyx_pybuffernd_proj.diminfo[1].shape)) __pyx_t_10 = 1;
    if (unlikely(__pyx_t_10 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_10);
      __PYX_ERR(0, 16, __pyx_L1_error)
    }
    __pyx_v_y = ((int)(*__Pyx_BufPtrStrided2d(__pyx_t_4data_11cython_util_DTYPE_t *, __pyx_pybuffernd_proj.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_proj.diminfo[0].strides, __pyx_t_12, __pyx_pybuffernd_proj.diminfo[1].strides)));

    /* "data/cython_util.pyx":17
 *         x = int(proj[0, i])
 *         y = int(proj[1, i])
 *         if 0 < x and x <= width and 0 < y and y <= height:             # <<<<<<<<<<<<<<
 *             cur_depth = depth[x-1][y-1]
 ...
 */
    __pyx_t_14 = ((0 < __pyx_v_x) != 0);
    if (__pyx_t_14) {
    } else {
      __pyx_t_13 = __pyx_t_14;
      goto __pyx_L6_bool_binop_done;
    }
    __pyx_t_14 = ((__pyx_v_x <= __pyx_v_width) != 0);
    if (__pyx_t_14) {
    } else {
      __pyx_t_13 = __pyx_t_14;
      goto __pyx_L6_bool_binop_done;
    }
    __pyx_t_14 = ((0 < __pyx_v_y) != 0);
    if (__pyx_t_14) {
    } else {
      __pyx_t_13 = __pyx_t_14;
      goto __pyx_L6_bool_binop_done;
    }
    __pyx_t_14 = ((__pyx_v_y <= __pyx_v_height) != 0);
    __pyx_t_13 = __pyx_t_14;
    __pyx_L6_bool_binop_done:;
    if (__pyx_t_13) {

      /* "data/cython_util.pyx":18
 *         y = int(proj[1, i])
 *         if 0 < x and x <= width and 0 < y and y <= height:
 *             cur_depth = depth[x-1][y-1]             # <<<<<<<<<<<<<<
 *             if cur_depth == 0 or cur_depth > proj[2, i]:
 *                 depth[x-1][y-1] == proj[2, i]
 */
      __pyx_t_15 = (__pyx_v_x - 1);
      __pyx_t_1 = __Pyx_GetItemInt(((PyObject *)__pyx_v_depth), __pyx_t_15, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __pyx_t_15 = (__pyx_v_y - 1);
      __pyx_t_4 = __Pyx_GetItemInt(__pyx_t_1, __pyx_t_15, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 18, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_XDECREF_SET(__pyx_v_cur_depth, __pyx_t_4);
      __pyx_t_4 = 0;

      /* "data/cython_util.pyx":19
 *         if 0 < x and x <= width and 0 < y and y <= height:
 *             cur_depth = depth[x-1][y-1]
 *             if cur_depth == 0 or cur_depth > proj[2, i]:             # <<<<<<<<<<<<<<
 *                 depth[x-1][y-1] == proj[2, i]
 * 
 */
      __pyx_t_4 = __Pyx_PyInt_EqObjC(__pyx_v_cur_depth, __pyx_int_0, 0, 0); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 19, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      ...
      __pyx_t_10 = -1;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_pybuffernd_proj.diminfo[0].shape;
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_10 = 0;
      } else if (unlikely(__pyx_t_16 >= __pyx_pybuffernd_proj.diminfo[0].shape)) __pyx_t_10 = 0;
      if (__pyx_t_17 < 0) {
        __pyx_t_17 += __pyx_pybuffernd_proj.diminfo[1].shape;
        if (unlikely(__pyx_t_17 < 0)) __pyx_t_10 = 1;
      } else if (unlikely(__pyx_t_17 >= __pyx_pybuffernd_proj.diminfo[1].shape)) __pyx_t_10 = 1;
      if (unlikely(__pyx_t_10 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_10);
        __PYX_ERR(0, 19, __pyx_L1_error)
      }
      __pyx_t_4 = PyFloat_FromDouble((*__Pyx_BufPtrStrided2d(__pyx_t_4data_11cython_util_DTYPE_t *, __pyx_pybuffernd_proj.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_proj.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_proj.diminfo[1].strides))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 19, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_1 = PyObject_RichCompare(__pyx_v_cur_depth, __pyx_t_4, Py_GT); __Pyx_XGOTREF(__pyx_t_1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 19, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_14 = __Pyx_PyObject_IsTrue(__pyx_t_1); if (unlikely(__pyx_t_14 < 0)) __PYX_ERR(0, 19, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __pyx_t_13 = __pyx_t_14;
      __pyx_L11_bool_binop_done:;
      if (__pyx_t_13) {

        /* "data/cython_util.pyx":20
 *             cur_depth = depth[x-1][y-1]
 *             if cur_depth == 0 or cur_depth > proj[2, i]:
 *                 depth[x-1][y-1] == proj[2, i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_15 = (__pyx_v_x - 1);
        __pyx_t_1 = __Pyx_GetItemInt(((PyObject *)__pyx_v_depth), __pyx_t_15, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_15 = (__pyx_v_y - 1);
        __pyx_t_4 = __Pyx_GetItemInt(__pyx_t_1, __pyx_t_15, long, 1, __Pyx_PyInt_From_long, 0, 1, 1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 20, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __pyx_t_18 = 2;
        ...
        } else if (unlikely(__pyx_t_18 >= __pyx_pybuffernd_proj.diminfo[0].shape)) __pyx_t_10 = 0;
        if (__pyx_t_19 < 0) {
          __pyx_t_19 += __pyx_pybuffernd_proj.diminfo[1].shape;
          if (unlikely(__pyx_t_19 < 0)) __pyx_t_10 = 1;
        } else if (unlikely(__pyx_t_19 >= __pyx_pybuffernd_proj.diminfo[1].shape)) __pyx_t_10 = 1;
        if (unlikely(__pyx_t_10 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_10);
          __PYX_ERR(0, 20, __pyx_L1_error)
        }
        __pyx_t_1 = PyFloat_FromDouble((*__Pyx_BufPtrStrided2d(__pyx_t_4data_11cython_util_DTYPE_t *, __pyx_pybuffernd_proj.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_proj.diminfo[0].strides, __pyx_t_19, __pyx_pybuffernd_proj.diminfo[1].strides))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_3 = PyObject_RichCompare(__pyx_t_4, __pyx_t_1, Py_EQ); __Pyx_XGOTREF(__pyx_t_3); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 20, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
        __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_data_cython_util, __pyx_k_data_cython_util, sizeof(__pyx_k_data_cython_util), 0, 0, 1, 1},
  ...
  {&__pyx_kp_s_home_peng_baidu_VideoSegRec_DeM, __pyx_k_home_peng_baidu_VideoSegRec_DeM, sizeof(__pyx_k_home_peng_baidu_VideoSegRec_DeM), 0, 0, 1, 0},
 ...
 *     cdef int pix_num = proj.shape[1]
 */
  __pyx_tuple__10 = PyTuple_Pack(9, __pyx_n_s_proj, __pyx_n_s_height, __pyx_n_s_width, __pyx_n_s_depth, __pyx_n_s_pix_num, __pyx_n_s_x, __pyx_n_s_y, __pyx_n_s_i, __pyx_n_s_cur_depth); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(3, 0, 9, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_peng_baidu_VideoSegRec_DeM, __pyx_n_s_gen_depth_map, 9, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_data__cython_util) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "data.cython_util")) {
      if (unlikely(PyDict_SetItemString(modules, "data.cython_util", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     cdef int pix_num = proj.shape[1]
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_4data_11cython_util_1gen_depth_map, NULL, __pyx_n_s_data_cython_util); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_gen_depth_map, __pyx_t_2) < 0) __PYX_ERR(0, 9, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "data/cython_util.pyx":1
 * from __future__ import division             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init data.cython_util", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init data.cython_util");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
