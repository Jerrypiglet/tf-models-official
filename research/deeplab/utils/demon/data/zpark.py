...
def set_params(val_id=-1):
    ...
    params['class_names'] = ['background', 'sky', 'car', 'bike', 'pedestrian', 'cyclist',
           'unknown-surface', 'car-lane', 'pedestrian-lane', 'bike-lane', 'unknown', 'unknown-road-edge',
           'curb', 'unknown-lane-barrier', 'traffic-cone', 'traffic-stack', 'fence', 'unknown-road-side-obj',
           'light-pole', 'traffic-light', 'telegraph-pole', 'traffic-sign', 'billboard',
           'bus-stop-sign', 'temp-building', 'building', 'newstand', 'policestand', 'unknown', 'unknown',
           'unknown-plants', 'plants', 'vehicle', 'motor-vehicle', 'bike', 'pedestrian', 'cyclist']
